...
/**
 * Display name and avatar, read from and written back to the onboarding profile
 * (`coderaid:profile`) — the record that already owns the player's identity.
 * The rest of the draft (path, experience, onboarding step) is preserved on
 * save, so editing a name here can't reopen onboarding.
 */
