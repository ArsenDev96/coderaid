...
/**
 * Compact orientation panel: which mission, what this step is for, how far in.
 * Deliberately free of rewards/XP widgets — the shared top bar carries those.
 */
export function DiagnosisMissionHeader({
  title,
  description,
  severity,
  step,
    ...
    <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-4 sm:p-5">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex min-w-0 gap-4">
          ...
          >
            <UserRound className="h-7 w-7 text-violet-300" strokeWidth={1.6} />
          </span>
        ...
        <div className="shrink-0 lg:max-w-[15rem]">
          ...
          <h2 className="mt-1 text-base font-semibold text-white">Diagnosis</h2>
          <p className="mt-1 text-xs leading-relaxed text-slate-400">
            Identify the root cause using the evidence you collected.
          </p>
